...
describe NewslettersController do
  ...
  let(:valid_attributes) { { "to" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved newsletter as @newsletter" do
        ...
        post :create, {:newsletter => { "to" => "invalid value" }}, valid_session
        assigns(:newsletter).should be_a_new(Newsletter)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested newsletter" do
        ...
        Newsletter.any_instance.should_receive(:update).with({ "to" => "MyText" })
        put :update, {:id => newsletter.to_param, :newsletter => { "to" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the newsletter as @newsletter" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Newsletter.any_instance.stub(:save).and_return(false)
        put :update, {:id => newsletter.to_param, :newsletter => { "to" => "invalid value" }}, valid_session
        assigns(:newsletter).should eq(newsletter)
      end
